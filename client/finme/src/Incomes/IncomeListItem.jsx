...
const IncomeListItem = ({
  ...
  return (
    <div className="grid grid-cols-5 gap-4 items-center w-full bg-gray-100 p-3 rounded-lg transform transition duration-300 hover:bg-sky-100">
      ...
      <button onClick={() => onDelete(incomeId)} className='w-fit justify-self-end me-14'>
